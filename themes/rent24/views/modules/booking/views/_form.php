		...
		if(!$model->date_start){
            if (!empty($date_start)) {
                if(Yii::app()->language != 'ru'){
                    $model->date_start = date('m/d/Y', strtotime($date_start));
                } else {
                    $model->date_start = Yii::app()->dateFormatter->formatDateTime(strtotime($date_start), 'medium', null);
                }
            } else {
...
<div class="row">
	<div class="full-multicolumn-first">
        ...
        if(!$model->date_end){
            if (!empty($date_end)) {
                if(Yii::app()->language != 'ru'){
                    $model->date_end = date('m/d/Y', strtotime($date_end));
                } else {
                    $model->date_end = Yii::app()->dateFormatter->formatDateTime(strtotime($date_end), 'medium', null);
                }
            }
        }
		if (!$isSimpleForm && $useBookingCalendar) {
