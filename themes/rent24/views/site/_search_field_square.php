    ...
    <span class="search"><div class="<?php echo $textClass; ?>"><?php echo Yii::t('common', 'Square range'); ?>:</div> </span>
        <span class="search">
            ...
            echo '</span>';
                ...
                <span class="search float-l"><div class="<?php echo $textClass; ?>"><?php echo Yii::t('common', 'Apartment square to'); ?>:</div></span>
                <span class="search float-r">
                    <span class="right-suffix grey-text right-suffix-small"><?php echo tc("site_square"); ?></span>
                    <input onblur="changeSearch();" type="text" id="squareTo" name="square"
                           class="width95 cell-input-big search-input-new"
