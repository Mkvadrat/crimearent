    ...
    <span class="search"><div class="<?php echo $textClass; ?>"><?php echo Yii::t('common', 'Rooms range'); ?>:</div> </span>
        <span class="search">
            ...
            echo '</span>';
                ...
                ?>
                <span class="search float-l"><div class="<?php echo $textClass; ?>"><?php echo Yii::t('common', 'Number of rooms'); ?>:</div> </span>
                ...
                echo CHtml::dropDownList('rooms', isset($this->roomsCount) ? CHtml::encode($this->roomsCount) : 0, $roomItems, array('class' => $fieldClass . ' searchField'.' filter-select'));
                ?>
                  </span>
                <?php
