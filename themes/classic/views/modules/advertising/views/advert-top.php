<?php if ($this->advertPos1 || $this->advertPos2): ?>
	<div class="advertising-blocks-top">
		<?php if ($this->advertPos1):?>
			<?php $i = 0; ?>
			<div class="advertising-blocks-top-left">
				<?php
		...
		<?php if ($this->advertPos2): ?>
			<?php $i = 0; ?>
			<div class="advertising-blocks-top-right">
				<?php
...
<?php if($this->advertPos3): ?>
	<?php $i = 0; ?>
	<div class="advertising-blocks-top advertising-blocks-top-center">
		<?php
