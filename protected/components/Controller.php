...
class Controller extends CController {
	...
	function init() {
		...
		if(!Yii::app()->user->isGuest && !Yii::app()->user->getState('isAdmin') && Yii::app()->theme->name != 'atlas'){
		...
		$this->aData['userCpanelItems'] = array(
			...
			array(
				'label' => '|',
				'visible' => param('useUserads', 0) == 1 && Yii::app()->theme->name == 'classic'
			),
		...
		if(!Yii::app()->user->isGuest){
			$user = HUser::getModel();
			$this->aData['userCpanelItems'][] = array('label' => '|', 'visible' => Yii::app()->theme->name == 'classic');
