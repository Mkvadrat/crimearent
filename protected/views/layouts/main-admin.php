...
<head>
	...
	<link media="screen, projection" type="text/css" href="<?php echo $baseThemeUrl; ?>/css/admin-styles.css" rel="stylesheet"/>

	<!--[if IE]>
	<link href="<?php echo $baseThemeUrl; ?>/css/ie.css" rel="stylesheet" type="text/css"> <![endif]-->
	...
	<?php
		...
		elseif(param('useOSMMap') == 1) {
			...
			Yii::app()->clientScript->registerScriptFile($baseThemeUrl . '/js/leaflet/leaflet-0.7.2/leaflet.js', CClientScript::POS_HEAD);
			Yii::app()->clientScript->registerCssFile($baseThemeUrl . '/js/leaflet/leaflet-0.7.2/leaflet.css');

			Yii::app()->clientScript->registerScriptFile($baseThemeUrl . '/js/leaflet/leaflet-0.7.2/dist/leaflet.markercluster-src.js', CClientScript::POS_HEAD);
			Yii::app()->clientScript->registerCssFile($baseThemeUrl . '/js/leaflet/leaflet-0.7.2/dist/MarkerCluster.css');
			Yii::app()->clientScript->registerCssFile($baseThemeUrl . '/js/leaflet/leaflet-0.7.2/dist/MarkerCluster.Default.css');
		}
            ...
            <div class="well sidebar-nav">
				<?php
					...
					'items' => array(
						...
						array('label' => tt('Clients', 'clients')),
						array('label' => tt('Clients', 'clients'), 'icon' => 'icon-list-alt', 'url' => $baseUrl . '/clients/backend/main/admin', 'active' => isActive('clients')),
						...
						array('label' => tt('Messages', 'messages'), 'visible' => issetModule('messages')),
						array('label' => tt('Messages', 'messages') . $bageMessages, 'icon' => 'icon-list-alt', 'url' => $baseUrl . '/messages/backend/main/admin', 'active' => (isActive('messages') || isActive('messages.read')), 'visible' => issetModule('messages')),
						array('label' => tt('Mailing messages', 'messages'), 'icon' => 'icon-list-alt', 'url' => $baseUrl . '/messages/backend/mailing/admin', 'active' => isActive('messages.mailing'), 'visible' => issetModule('messages')),
						...
						array('label' => tc('Manage themes'), 'icon' => 'icon-wrench', 'url' => $baseUrl . '/themes/backend/main/admin', 'active' => isActive('themes'), 'visible' => issetModule('themes')),

						array('label' => tc('Languages and currency')),
						array('label' => tc('Languages'), 'icon' => 'icon-globe', 'url' => $baseUrl . '/lang/backend/main/admin', 'active' => isActive('lang'), 'visible' => !isFree()),
						...
						array('label' => tc('Currencies'), 'icon' => 'icon-wrench', 'url' => $baseUrl . '/currency/backend/main/admin', 'active' => isActive('currency'), 'visible' => issetModule('currency')),
                        ...
                        array('label' => tc('Subscriptions'), 'icon' => 'icon-file', 'url' => $baseUrl . '/apartments/backend/main/subscriptions', 'active' => isActive('apartments.subscriptions')),
					),
				));
				?>
            </div>
