...
if (!SocialpostingModel::getSocialParamValue('useVkontakte')) {
	...
	$infoHelp .= Yii::t('module_socialposting', 'Get a Token for VK.com - {link}', array('{link}' => CHtml::link('http://oauth.vk.com/authorize?client_id=YOUR_APPLICATION_ID&scope=wall,offline&redirect_uri=http://oauth.vk.com/blank.html&response_type=token', 'http://oauth.vk.com/authorize?client_id=YOUR_APPLICATION_ID&scope=wall,offline&redirect_uri=http://oauth.vk.com/blank.html&response_type=token',  array('target' => '_blank'))));
}
